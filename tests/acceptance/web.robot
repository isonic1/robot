...
*** Variables ***
&{RUNNER}   classic=ClassicRunner               ufg=VisualGridRunner
...
Setup
    ...
    Open Browser                ${url}                  gc
    Open Eyes Session           ${RUNNER.classic}               ${API KEY}      Web Tests       ${test name}        serverurl=${Server URL}     width=1200      height=600      matchlevel=strict       enable_eyes_log=${true}     batch=Robot
